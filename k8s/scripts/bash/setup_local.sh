...
echo ""
echo "🔌 Useful Port-Forward Commands (Run in separate terminals):"
echo "   - TimescaleDB (Local Access): kubectl port-forward svc/timescaledb 5432:5432"
echo "   - Tempo (OTLP gRPC):          kubectl port-forward svc/tempo 4317:4317"
